        ...
        <div className="min-h-screen bg-[#030303] text-white selection:bg-purple-500/30">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <Link href="/pro/S01" className="hidden sm:flex items-center space-x-2 px-4 py-2 bg-purple-600 text-white text-sm font-semibold rounded-full hover:bg-purple-500 transition-all">
            ...
            <main className="relative pt-32 pb-24">
                <div className="max-w-4xl mx-auto px-4">
                    <Link href="/pro" className="inline-flex items-center space-x-2 text-white/40 hover:text-white transition-colors mb-12 group">
                        <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
                        <span className="text-sm font-medium">{t('pro.legal.backToHome')}</span>
                    </Link>
